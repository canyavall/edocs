...
INSERT INTO user (id, created, is_company, name, surname, identity_number, email, country, password, language) VALUES (3, {ts '2017-01-01 00:00:00.00'}, 0, 'Karis', 'Shae', '37389778', 'Kari.SAUNDERS9199@gmail.com', 'United States', '8dB2t8eEdR', 'us');
INSERT INTO user (id, created, is_company, name, surname, identity_number, email, country, password, language) VALUES (4, {ts '2017-01-01 00:00:00.00'}, 1, 'Rihanna', 'Kinsey', '05689529', 'Riha.OL1538@yahoo.com', 'United States', 'ToLe6Tpwzb', 'us');
INSERT INTO user (id, created, is_company, name, surname, identity_number, email, country, password, language) VALUES (5, {ts '2017-01-01 00:00:00.00'}, 1, 'Lilah', 'Sidney', '18932616', 'Li.REYNOL7789@hushmail.com', 'United States', 'UWq79GcvTX', 'us');
INSERT INTO user (id, created, is_company, name, surname, identity_number, email, country, password, language) VALUES (6, {ts '2017-01-01 00:00:00.00'}, 0, 'Brennen', 'Sidney', '29657247', 'Brenn.MILL4124@live.com', 'United States', 'PdFbYPfiTu', 'us');
INSERT INTO user (id, created, is_company, name, surname, identity_number, email, country, password, language) VALUES (7, {ts '2017-01-01 00:00:00.00'}, 1, 'Yosef', 'Devyn', '03523209', 'Yos.COX8743@live.com', 'United States', 'iCxZA6N6pl', 'us');
INSERT INTO user (id, created, is_company, name, surname, identity_number, email, country, password, language) VALUES (8, {ts '2017-01-01 00:00:00.00'}, 1, 'Barbara', 'Tawanda', '88962627', 'Barbar.WHITF8199@live.com', 'United States', '7gMqVpStCW', 'us');
INSERT INTO user (id, created, is_company, name, surname, identity_number, email, country, password, language) VALUES (9, {ts '2017-01-01 00:00:00.00'}, 1, 'Layne', 'Lexis', '87374328', 'Lay.FORD9298@gmail.com', 'United States', 'SpW5RTmmmf', 'us');
INSERT INTO user (id, created, is_company, name, surname, identity_number, email, country, password, language) VALUES (10, {ts '2017-01-01 00:00:00.00'}, 1, 'Lyla', 'Robin', '08404823', 'Lyla.ROWL7168@mail2web.com', 'United States', 'm9a569L6sH', 'us');
